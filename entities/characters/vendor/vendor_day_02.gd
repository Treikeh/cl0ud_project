...
@export var _profile_builder_02_dialogue: DialogueData
@export var _profile_builder_bought_dialogue: DialogueData
...
func _ready() -> void:
	...
	_profile_builder_01_dialogue.choice_made.connect(_on_profile_builder_01_dialogue_choice_made)
	_profile_builder_02_dialogue.choice_made.connect(_on_tutorial_dialouge_choice_made)


func _on_profile_builder_01_dialogue_choice_made(choice: int) -> void:
	var player: Player = get_tree().get_first_node_in_group("player")
	match choice:
		_: player.hud.start_dialogue.call_deferred(_profile_builder_02_dialogue)
